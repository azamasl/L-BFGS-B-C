      ...
      if (col == 0) {
        ...
        *task = ABNORMAL;
        ...
        prn3lb(n, &x[1], f, task, iprint, &info, o__1, &iter, &nfgv, &nintol,
               ...
               &k, &cachyt, &sbtime, &lnscht, (ftnlen) 60, (ftnlen) 3);
        //save and return
        printf("return from the lnsr info not zero \n");
        return 0;
      } else {
        /*   refresh the lbfgs memory and restart the iteration. */
        if (*iprint >= 1) {
...
//  lsave[1] = prjctd;lsave[2] = cnstnd;lsave[3] = boxed;lsave[4] = updatd;isave[1] = nintol;isave[3] = itfile;isave[4] = iback;
//  isave[5] = nskip;isave[6] = head;isave[7] = col;isave[8] = itail;isave[9] = iter;isave[10] = iupdat;isave[12] = nseg;
//  isave[13] = nfgv;isave[14] = info;isave[15] = ifun;isave[16] = iword;isave[17] = nfree;isave[18] = nact;isave[19] = ileave;
//  isave[20] = nenter;dsave[1] = theta;dsave[2] = fold;dsave[3] = tol;dsave[4] = dnorm;dsave[5] = epsmch;dsave[6] = cpu1;
//  dsave[7] = cachyt;dsave[8] = sbtime;dsave[9] = lnscht;dsave[10] = time1;dsave[11] = gd;dsave[12] = stpmx;dsave[13] = sbgnrm;
//  dsave[14] = stp;dsave[15] = gdold;dsave[16] = dtd;
  //printf("at L1000 : dtd = %5e \n", dtd);
  return 0;
} /* mainlb */
